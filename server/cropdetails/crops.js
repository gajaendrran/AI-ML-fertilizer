const cropTips = {
  ...
  Coffee: {
    days: 30,
    percentage: 25,
    irrigation: "Requires frequent light irrigation, especially during dry seasons.",
    additionalTips: "Shade trees help maintain soil moisture. Regular pruning improves yield.",
  },
  Cotton: {
    days: 20,
    percentage: 20,
  ...
  Kidneybeans: {
    days: 25,
    percentage: 30,
    irrigation: "Moderate irrigation is needed, especially during flowering and pod formation stages.",
    additionalTips: "Ensure proper spacing for air circulation. Monitor for pest damage and control accordingly.",
  },
  Maize: {
    days: 25,
    percentage: 30,
    irrigation: "Maize requires consistent irrigation, especially during tasseling and cob formation.",
  ...
  Orange: {
    days: 30,
    percentage: 25,
    irrigation: "Requires deep but infrequent irrigation, especially during fruit formation.",
    additionalTips: "Mulching helps retain soil moisture. Prune to maintain tree health.",
  },
  Paddy: {
    days: 30,
    percentage: 25,
    irrigation: "Flood irrigation is commonly used for paddy. Ensure adequate water during tillering and panicle initiation.",
    additionalTips: "Avoid waterlogging; monitor soil moisture and apply organic fertilizers for better soil health.",
  },
  Pomegranate: {
    days: 30,
    percentage: 25,
    irrigation: "Deep irrigation is required at regular intervals to encourage healthy root growth.",
    additionalTips: "Pruning helps in better fruiting. Avoid excessive watering to prevent root rot.",
  },
  Pulses: {
    days: 20,
    percentage: 20,
  ...
  Watermelon: {
    days: 25,
    percentage: 30,
    irrigation: "Requires frequent but light irrigation to ensure uniform fruit development.",
    additionalTips: "Avoid waterlogging. Use mulch to maintain soil moisture and prevent weeds.",
  },
  Wheat: {
    days: 25,
    percentage: 30,
